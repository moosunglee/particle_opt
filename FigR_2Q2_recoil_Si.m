...
for j0 = 1:3
    ...
    for j1 = 1:length(radius_list)
        scatter(radius_list(j1)*2, gammas_list(dim_list(j0),j1), 150, 'cs', ...
...
for j0 = 1:3
    ...
    for j1 = 1:length(radius_list)
        scatter(radius_list(j1)*2, freqs_list(dim_list(j0),j1) ./ gammas_list(dim_list(j0),j1), 150, 'cs', ...
              'MarkerEdgeColor','none',...
                  'MarkerFaceColor',c(1+round((depth_list((j1))-min_depth)/(max_depth-min_depth)*255),:),...
                'LineWidth',1)
    end
...
for j0 = 1:3
    ...
    set(gca, 'linewidth',1), hold on
    for j1 = 1:length(radius_list)
        scatter(radius_list(j1)*2, gammas_rot_list(dim_list(j0),j1), 150, 'cs', ...
              'MarkerEdgeColor','none',...
                  'MarkerFaceColor',c(1+round((depth_list((j1))-min_depth)/(max_depth-min_depth)*255),:),...
                'LineWidth',1)
    end
...
for j0 = 1:3
    ...
    set(gca, 'linewidth',1), hold on
    for j1 = 1:length(radius_list)
        scatter(radius_list(j1)*2, freqs_rot_list(dim_list(j0),j1) ./ gammas_rot_list(dim_list(j0),j1), 150, 's', ...
              'MarkerEdgeColor','none',...
                  'MarkerFaceColor',c(1+round((depth_list((j1))-min_depth)/(max_depth-min_depth)*255),:),...
                'LineWidth',1)
    end
